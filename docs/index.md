...
features:
  - title: <img src="../MooToolDoc/assets/logo/logo-128.png" alt="FeatureAIcon" width="64" height="64" /> 随手记
  ...
  - title: <img src="../MooToolDoc/assets/icon/method.svg" alt="FeatureAIcon" width="64" height="64" /> 加解密/随机
    details: 支持常见的加解密算法，如MD5、SHA1、AES、DES、RSA等。<br/>支持生成随机字符串、随机数字、随机密码等。
  - title: <img src="../MooToolDoc/assets/icon/calculate.svg" alt="FeatureAIcon" width="64" height="64" /> 计算
    details: 四则运算、进制转换、最大公约数、最小公倍数、排列组合等。<br/>自动保存历史记录。
  - title: <img src="../MooToolDoc/assets/icon/network.svg" alt="FeatureAIcon" width="64" height="64" /> 网络/IP
    details: 系统网络查询、IP地址转换、Ping、DNS刷新、本机IP列表、域名解析等。
  - title: <img src="../MooToolDoc/assets/icon/color.svg" alt="FeatureAIcon" width="64" height="64" /> 调色板
    details: 颜色管理神器，支持取色、颜色选择器、颜色转换、颜色搭配等。
  - title: <img src="../MooToolDoc/assets/icon/image.svg" alt="FeatureAIcon" width="64" height="64" /> 图片助手
    details: 本地图床、剪贴板图片的好去处。<br/>支持图片和Base64互转等。
  - title: <img src="../MooToolDoc/assets/icon/translate.svg" alt="FeatureAIcon" width="64" height="64" /> 翻译
    details: 施工中，敬请期待……
...
![Overview](/assets/screen_shoot/quick_replace_mac.png)

![Overview](/assets/screen_shoot/time_mac_2.png)

![Overview](/assets/screen_shoot/json_mac_2.png)

![Overview](/assets/screen_shoot/host_mac_2.png)

![Overview](/assets/screen_shoot/http_mac_2.png)

![Overview](/assets/screen_shoot/encode_mac_2.png)

![Overview](/assets/screen_shoot/qr_code_mac_2.png)

![Overview](/assets/screen_shoot/crypto_mac_2.png)

![Overview](/assets/screen_shoot/calculator_mac_2.png)

![Overview](/assets/screen_shoot/net_mac_2.png)

![Overview](/assets/screen_shoot/color_board_mac_2.png)

![Overview](/assets/screen_shoot/regex_mac_2.png)

![Overview](/assets/screen_shoot/cron_mac_2.png)
